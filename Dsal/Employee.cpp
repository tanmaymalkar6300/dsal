/*Company maintains employee information such as employee ID, name, designation and salary. 
Allow users to add, delete information about employees. Display information of a particular 
employee. If an employee does not exist an appropriate message is displayed. If it is, then the 
...
void deleteEmployee() {
    ...
    while (file.read(reinterpret_cast<char*>(&emp), sizeof(Employee))) {
        if (emp.employeeID == empID) {
            ...
            Employee emptyEmp;
            file.seekp(static_cast<std::streamoff>(file.tellg()) - static_cast<std::streamoff>(sizeof(Employee)));
